...
"# react-typescript-starter"  git init git add README.md git commit -m "first commit" git remote add origin https://github.com/aljondev/react-typescript-starter.git git push -u origin master
